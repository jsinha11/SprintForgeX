        ...
        while (choice != 0) 
        {
            ...
            switch (choice) 
            {
                ...
                case 4:
                    ...
                    sprintService.assignTask(currentSprint, tid, team.get(mi)); break;
                case 5:
                    if (currentSprint == null) { System.out.println("Plan a sprint first!"); break; }
                    System.out.print("Task ID to complete: "); int cid = scanner.nextInt();
                    sprintService.completeTask(currentSprint, cid); break;
                case 6:
                    if (currentSprint == null) { System.out.println("Plan a sprint first!"); break; }
                    sprintService.completeSprint(currentSprint, velocityTracker);
                    currentSprint = null; break;
                case 7: velocityTracker.displayHistory(); break;
